...
<div class="min-h-screen bg-gradient-to-b from-[#EAF4FF] via-[#DCEEFF] to-[#EAF4FF] al-font-body text-[#0B2545]">
    ...
    <div class="max-w-3xl mx-auto py-20 px-6">
        ...
        <div class="bg-white/70 backdrop-blur-md border border-[#0B2545]/10 rounded-3xl p-8 md:p-12 shadow-xl shadow-[#0B2545]/5 al-legal-content">
            ...
            <p>Bu web sitesini kullanarak aşağıdaki kullanım şartlarını kabul etmiş sayılırsınız. Lütfen siteyi kullanmadan önce bu şartları dikkatlice okuyunuz.</p>

            <h2>1. Genel Hükümler</h2>
            <p>Bu site AL TECHNOLOGY tarafından işletilmektedir. Sitede yer alan tüm içerikler, ticari markalar ve tasarımlar AL TECHNOLOGY'nin mülkiyetindedir ve izinsiz kullanılamaz.</p>

            <h2>2. Hizmetlerin Kapsamı</h2>
            <p>AL TECHNOLOGY, yazılım geliştirme, bulut altyapı ve teknik destek hizmetleri sunmaktadır. Sitede yer alan bilgiler tanıtım amaçlıdır ve bağlayıcı bir teklif niteliği taşımaz; teklifler ancak yazılı sözleşme ile geçerlilik kazanır.</p>
            ...
            <p>Sitede yer alan tüm metin, görsel, logo ve yazılım unsurları telif hakkı ile korunmaktadır. Önceden yazılı izin alınmadan çoğaltılamaz, dağıtılamaz veya ticari amaçla kullanılamaz.</p>

            <h2>5. Sorumluluğun Sınırlandırılması</h2>
            <p>AL TECHNOLOGY, sitenin kesintisiz veya hatasız çalışacağını garanti etmez. Site kullanımından doğabilecek doğrudan veya dolaylı zararlardan sorumlu tutulamaz.</p>

            <h2>6. Değişiklikler</h2>
            <p>AL TECHNOLOGY, bu kullanım şartlarını dilediği zaman güncelleme hakkını saklı tutar. Güncellemeler sitede yayımlandığı andan itibaren yürürlüğe girer.</p>

            <h2>7. İletişim</h2>
            <p>Bu şartlarla ilgili sorularınız için <span class="font-semibold text-[#0B2545]">info@altechnology.com</span> adresinden bize ulaşabilirsiniz.</p>
