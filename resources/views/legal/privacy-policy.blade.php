...
<div class="min-h-screen bg-gradient-to-b from-[#EAF4FF] via-[#DCEEFF] to-[#EAF4FF] al-font-body text-[#0B2545]">
    ...
    <div class="max-w-3xl mx-auto py-20 px-6">
        ...
        <div
            ...
            <p>AL TECHNOLOGY olarak kişisel verilerinizin gizliliğine ve güvenliğine büyük önem veriyoruz. Bu politika,
                web sitemiz ve hizmetlerimiz üzerinden topladığımız verilerin nasıl işlendiğini açıklamaktadır.</p>
            ...
            <p>Topladığımız veriler; hizmetlerimizi sunmak, taleplerinize yanıt vermek, site deneyimini iyileştirmek ve
                yasal yükümlülüklerimizi yerine getirmek amacıyla kullanılır.</p>

            <h2>3. Verilerin Paylaşımı</h2>
            <p>Kişisel verileriniz, yasal zorunluluklar dışında, açık rızanız olmadan üçüncü taraflarla paylaşılmaz.
                Hizmet sağlayıcılarımızla yapılan paylaşımlar, gizlilik sözleşmeleri kapsamında sınırlandırılmıştır.</p>

            <h2>4. Veri Güvenliği</h2>
            <p>Verilerinizin korunması için endüstri standardı teknik ve idari güvenlik önlemleri uyguluyoruz. ISO/IEC
                27001 Bilgi Güvenliği Yönetim Sistemi standardına uygun olarak çalışıyoruz.</p>

            <h2>5. Haklarınız</h2>
            <p>KVKK kapsamında; verilerinizin işlenip işlenmediğini öğrenme, düzeltilmesini veya silinmesini talep etme
                haklarına sahipsiniz. Taleplerinizi <span
                    class="font-semibold text-[#0B2545]">info@altechnology.com</span> adresine iletebilirsiniz.</p>

            <h2>6. İletişim</h2>
            <p>Bu politika hakkında sorularınız için bizimle İstanbul, Türkiye ofisimiz üzerinden veya yukarıdaki
                e-posta adresinden iletişime geçebilirsiniz.</p>
