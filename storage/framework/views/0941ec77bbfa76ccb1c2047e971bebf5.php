        ...
        <div
            ...
            <div class="divide-y divide-[#0B2545]/10">
                ...
                <div class="animate-row py-5 flex items-center justify-between gap-6 group">
                    ...
                    <a href="<?php echo e(asset('documents/iso_27001_sertifikasi.pdf')); ?>" download
                ...
                <div class="animate-row py-5 flex items-center justify-between gap-6 group"
                    ...
                    <a href="<?php echo e(asset('documents/iso_9001_sertifikasi.pdf')); ?>" download
                        class="al-font-mono text-xs font-bold tracking-wider text-[#2F6FED] hover:text-[#FF9F45] bg-[#EAF4FF] hover:bg-[#0B2545] px-4 py-2.5 rounded-full shadow-sm transition-all duration-300 shrink-0">
                        İNDİR (PDF)
                    </a>
                </div>
                ...
                <div class="animate-row py-5 flex items-center justify-between gap-6 group"
                    ...
                    <a href="<?php echo e(asset('documents/kvkk_politikasi.pdf')); ?>" download
                        class="al-font-mono text-xs font-bold tracking-wider text-[#2F6FED] hover:text-[#FF9F45] bg-[#EAF4FF] hover:bg-[#0B2545] px-4 py-2.5 rounded-full shadow-sm transition-all duration-300 shrink-0">
                        İNCELE
                    </a>
                </div>
...
<?php echo $__env->make('layouts.full', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\apoca\Desktop\livewire-projem\resources\views/Kurumsal/belgeler.blade.php ENDPATH**/ ?>