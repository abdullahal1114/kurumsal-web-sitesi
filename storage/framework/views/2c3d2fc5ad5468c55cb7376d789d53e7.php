...
<style>
    ...
    .al-pulse-delay { animation: al-pulse-line 4s ease-in-out infinite; animation-delay: 1.5s; }
...
<div class="min-h-screen bg-gradient-to-b from-[#EAF4FF] via-[#DCEEFF] to-[#EAF4FF] al-font-body text-[#0B2545] selection:bg-[#FFB347] selection:text-[#0A1830]">
    ...
    <nav class="al-navbar sticky top-4 z-50 max-w-6xl mx-auto flex items-center justify-between px-6 md:px-8 py-4 rounded-full mt-4 border border-white/60">
        <div class="al-font-display text-2xl font-bold tracking-tight text-[#0B2545] cursor-pointer hover:opacity-70 transition-opacity duration-300">
        ...
        <div class="hidden md:flex items-center gap-9 al-font-mono text-xs tracking-[0.15em] text-[#0B2545]/60">
            ...
            <div class="relative group">
                <a href="<?php echo e(route('kurumsal')); ?>" class="flex items-center gap-1 hover:text-[#0B2545] hover:opacity-100 opacity-70 transition-all duration-300 py-3 cursor-pointer">
                    KURUMSAL
                ...
                <div class="absolute top-full left-1/2 -translate-x-1/2 pt-2 w-56
                    ...
                    <div class="bg-white/95 backdrop-blur-md border border-[#0B2545]/10 rounded-2xl shadow-xl shadow-[#0B2545]/10 p-3 flex flex-col gap-2">
                        ...
                        <a href="<?php echo e(route('kurumsal.hakkimizda')); ?>" class="al-font-body normal-case tracking-normal text-sm font-semibold text-white text-center bg-[#0B2545] hover:bg-[#2F6FED] transition-colors duration-300 rounded-xl py-3 px-4">
                            Hakkımızda
                        </a>

                        <a href="<?php echo e(route('kurumsal.vizyon-misyon')); ?>" class="al-font-body normal-case tracking-normal text-sm font-semibold text-white text-center bg-[#0B2545] hover:bg-[#2F6FED] transition-colors duration-300 rounded-xl py-3 px-4">
                            Vizyon - Misyon
                        </a>

                        <a href="<?php echo e(route('kurumsal.haberler')); ?>" class="al-font-body normal-case tracking-normal text-sm font-semibold text-white text-center bg-[#0B2545] hover:bg-[#2F6FED] transition-colors duration-300 rounded-xl py-3 px-4">
                            Haberler
                        </a>

                        <a href="<?php echo e(route('kurumsal.belgeler')); ?>" class="al-font-body normal-case tracking-normal text-sm font-semibold text-white text-center bg-[#0B2545] hover:bg-[#2F6FED] transition-colors duration-300 rounded-xl py-3 px-4">
                            Belgeler
                        </a>
           ...
           <a href="<?php echo e(route('referanslar')); ?>" class="hover:text-[#0B2545] hover:opacity-100 opacity-70 transition-all duration-300">
    REFERANSLAR
</a>
            <a href="#" class="hover:text-[#0B2545] hover:opacity-100 opacity-70 transition-all duration-300">ÜRÜNLER</a>
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-223960328-0', $__key);
...
?>
    ...
    <header class="relative py-28 md:py-36 px-6 overflow-hidden">
        <div class="absolute inset-0 al-grid-bg pointer-events-none"></div>
         ...
         ince veri akışı çizgileri 
        <div class="absolute top-1/4 left-0 w-full h-px bg-gradient-to-r from-transparent via-[#FF9F45]/50 to-transparent al-pulse"></div>
        <div class="absolute top-2/3 left-0 w-full h-px bg-gradient-to-r from-transparent via-[#2F6FED]/40 to-transparent al-pulse-delay"></div>

        <div class="relative max-w-5xl mx-auto text-center">
            <p class="al-font-mono text-xs tracking-[0.3em] text-[#FF9F45] mb-6">DİJİTAL DÖNÜŞÜM PARTNERİ</p>

            <h1 class="al-font-display text-6xl md:text-8xl font-extrabold mb-6 leading-[0.95] tracking-tight text-[#0B2545]">
                AL TECHNOLOGY
            </h1>
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 bg-white/70 backdrop-blur-sm border border-[#0B2545]/10 rounded-2xl p-8 shadow-sm">
...
<script>
    ...
    <section class="max-w-7xl mx-auto px-6 pb-32">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
             ...
             Yazılım Çözümleri 
            <div class="group relative h-96 border border-[#0B2545]/10 overflow-hidden hover:border-[#FF9F45]/50 transition-all duration-500 cursor-pointer rounded-2xl shadow-sm hover:shadow-xl hover:shadow-[#2F6FED]/10">
    ...
    <section class="max-w-7xl mx-auto px-6 pb-32">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="flex gap-5 bg-white/60 backdrop-blur-sm border border-[#0B2545]/10 rounded-2xl p-7 hover:border-[#2F6FED]/30 hover:bg-white transition-all duration-500">
                ...
                <ul class="space-y-5">
                    <li class="flex items-start gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-blue-100/50 text-sm">Alanında deneyimli mühendis ve mimarlardan oluşan ekip.</p>
                        </div>
                    </li>
                    <li class="flex items-start gap-4">
        ...
        <div class="relative max-w-7xl mx-auto px-6 md:px-8 pt-20 pb-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                ...
                <div class="md:col-span-2">
                    ...
                    <div class="flex gap-3">
                        <a href="https://www.facebook.com/kullaniciadi" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full border border-white/15 flex items-center justify-center hover:border-[#FF9F45]/60 hover:bg-[#FF9F45]/10 transition-all duration-300">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15h-2.4v-3H10V9.5C10 7.15 11.5 6 13.6 6c.94 0 1.9.17 1.9.17v2.5h-1.27c-1.25 0-1.63.78-1.63 1.58V12h2.78l-.44 3H12.6v6.8c4.56-.93 8-4.96 8-9.8z"/></svg>
                        </a>
    
                        <a href="https://www.linkedin.com/company/physiqdynamic/posts/?feedView=all" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full border border-white/15 flex items-center justify-center hover:border-[#FF9F45]/60 hover:bg-[#FF9F45]/10 transition-all duration-300">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M19 3a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h14zM8.34 18.5v-8.4H5.67v8.4h2.67zM7 8.9c.85 0 1.4-.56 1.4-1.27C8.38 6.93 7.85 6.4 7.02 6.4c-.84 0-1.4.53-1.4 1.24 0 .7.54 1.27 1.36 1.27h.02zM18.5 18.5v-4.7c0-2.5-1.34-3.67-3.13-3.67-1.44 0-2.08.8-2.44 1.35v-1.16h-2.67c.03.7 0 8.18 0 8.18h2.67v-4.57c0-.24.02-.49.1-.66.2-.49.66-1 1.44-1 1.02 0 1.43.78 1.43 1.9v4.33h2.6z"/></svg>
                        </a>
    
                        <a href="https://x.com/MrBeast" target="_blank" rel="noopener noreferrer" class="w-10 h-10 rounded-full border border-white/15 flex items-center justify-center hover:border-[#FF9F45]/60 hover:bg-[#FF9F45]/10 transition-all duration-300">
                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M8.29 20.25c7.55 0 11.68-6.26 11.68-11.68 0-.18 0-.36-.01-.53a8.35 8.35 0 002.05-2.13 8.19 8.19 0 01-2.36.65 4.12 4.12 0 001.81-2.27 8.22 8.22 0 01-2.6 1 4.1 4.1 0 00-6.99 3.74A11.65 11.65 0 013.15 4.6a4.1 4.1 0 001.27 5.47A4.07 4.07 0 012.8 9.5v.05a4.1 4.1 0 003.29 4.02 4.1 4.1 0 01-1.85.07 4.1 4.1 0 003.83 2.85A8.23 8.23 0 012 18.4a11.62 11.62 0 006.29 1.84"/></svg>
                        </a>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3 text-sm text-blue-100/60">
                        <li><a href="<?php echo e(route('kurumsal.hakkimizda')); ?>" class="hover:text-white transition-colors duration-300">Hakkımızda</a></li>
                        <li><a href="<?php echo e(route('referanslar')); ?>" class="hover:text-white transition-colors duration-300">Referanslar</a></li>
                        <li><a href="<?php echo e(route('kurumsal')); ?>" class="hover:text-white transition-colors duration-300">Kariyer</a></li>
            ...
            <div class="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
                <p class="al-font-mono text-xs text-blue-100/40 tracking-wide">
                    © <?php echo e(date('Y')); ?> AL TECHNOLOGY — TÜM HAKLARI SAKLIDIR
                </p>
                <div class="flex gap-6 al-font-mono text-xs text-blue-100/40">
                    <a href="<?php echo e(route('policy.show')); ?>" target="_blank" class="hover:text-white transition-colors duration-300">Gizlilik Politikası</a>
                    <a href="<?php echo e(route('terms.show')); ?>" target="_blank" class="hover:text-white transition-colors duration-300">Kullanım Şartları</a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.full', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\apoca\Desktop\livewire-projem\resources\views/livewire/pages/auth/home.blade.php ENDPATH**/ ?>