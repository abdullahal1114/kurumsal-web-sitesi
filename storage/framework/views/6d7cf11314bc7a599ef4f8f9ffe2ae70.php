    ...
    <div class="min-h-screen bg-gradient-to-b from-[#EAF4FF] via-[#DCEEFF] to-[#EAF4FF]">
        ...
        <div class="max-w-7xl mx-auto py-10 px-6 opacity-0 animate-fade-in-up">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?>[if BLOCK]><![endif]<?php endif; ?><?php $__currentLoopData = $referanslar; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $ref): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div
                    class="relative group h-[420px] rounded-[2rem] overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 border border-[#0B2545]/10 opacity-0 animate-fade-in-up <?php echo e($index % 2 == 0 ? 'stagger-1' : 'stagger-2'); ?>">

                    <img src="<?php echo e(asset('images/' . $ref['dosya'])); ?>"
                    ...
                    <div
                        ...
                        <h3 class="text-white text-3xl font-extrabold mb-3 drop-shadow-md"><?php echo e($ref['isim']); ?></h3>
...
<?php endif; ?><?php /**PATH C:\Users\apoca\Desktop\livewire-projem\resources\views/referanslar.blade.php ENDPATH**/ ?>