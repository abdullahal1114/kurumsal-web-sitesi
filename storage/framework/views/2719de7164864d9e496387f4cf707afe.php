        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mt-8">
            ...
            <div class="lg:col-span-5 animate-fade-in-up animate-delay-100 lg:sticky lg:top-28">
                <div
                    ...
                    <img src="<?php echo e(asset('images/tech-hub.jpg')); ?>" alt="AL Technology Tech Hub"
...
<?php echo $__env->make('layouts.full', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\apoca\Desktop\livewire-projem\resources\views/Kurumsal/hakkimizda.blade.php ENDPATH**/ ?>