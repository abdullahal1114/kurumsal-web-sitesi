...
<div class="min-h-screen bg-gradient-to-b from-[#EAF4FF] via-[#DCEEFF] to-[#EAF4FF] al-font-body text-[#0B2545] selection:bg-[#FFB347] selection:text-[#0A1830]"
    ...
    <nav
        ...
        <div class="hidden md:flex items-center gap-9 al-font-mono text-xs tracking-widest text-[#0B2545]/60">
            ...
            <a href="<?php echo e(route('urunler')); ?>" class="text-[#0B2545] opacity-100">ÜRÜNLER</a>
            ...
            => ['7/24 destek hattı', 'Ort. <5dk müdahale', 'Aylık sağlık raporu' ]], ];
                ...
                <div x-show="active === 'all' || active === '<?php echo e($urun['kategori']); ?>'"
                    ...
                    <div class="p-7 flex flex-col h-full">
                        ...
                        <button type="button"
                            @click="Livewire.dispatch('openQuoteModal', { product: <?php echo \Illuminate\Support\Js::from($urun['ad'])->toHtml() ?>, service: <?php echo \Illuminate\Support\Js::from($kategoriServisEtiketi[$urun['kategori']])->toHtml() ?> })"
...
<?php echo $__env->make('layouts.full', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\apoca\Desktop\livewire-projem\resources\views/urunler.blade.php ENDPATH**/ ?>